...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            {
                string tempBindingName = action.bindings[bindingIndex].name.ToUpper()[0] + action.bindings[bindingIndex].name.ToLower().Substring(1);

            }
                partName = $"'{m_ActionLabel.text}'\n";
            ...
            if (m_RebindText != null)
            {
                var text = !string.IsNullOrEmpty(m_RebindOperation.expectedControlType)
                    ? /*$"{partName}Waiting for {m_RebindOperation.expectedControlType} input..."*/$"{partName}Press any key..."
        ...
        private void DuplicateBinding(InputBinding binding)
        {
